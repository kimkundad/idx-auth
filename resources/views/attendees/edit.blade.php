...
<div class="container py-4">
        ...
        <div class="row g-3">
          ...
          <div class="col-md-4">
            ...
            <select class="form-select" name="status">
              ...
              <option value="rejected" {{ old('status',$attendee->status)==='rejected'?'selected':'' }}>rejected</option>
            </select>
          </div>
  ...
  <select class="form-select" id="provinceSelect" name="province">
    @php $pv = old('province', $attendee->province); @endphp
  ...
  {{-- hidden สำหรับบันทึก boolean --}}
  <input type="hidden" id="province_type_1" name="province_type_1" value="{{ old('province_type_1', $attendee->province_type_1 ? 1 : 0) }}">
  <input type="hidden" id="province_type_2" name="province_type_2" value="{{ old('province_type_2', $attendee->province_type_2 ? 1 : 0) }}">
</div>


          {{-- Travel --}}
          @php
            // ค่าเดิมใน DB เก็บเป็นหลายบรรทัด
            $travelRaw = old('travel_from_province', $attendee->travel_from_province ?? '');
